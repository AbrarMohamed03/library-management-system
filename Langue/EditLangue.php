...
<body>
    ...
    ?>
        ...
        <div class="butt">
            ...
            <button type="button" class="btn btn-dark"><a href="FormEditlangue.php" class="" style="text-decoration: none;color:white">Retour au formaulaire de saisie</a></button>
        </div>
    <?php
    } else
        while ($row = $table->fetch(PDO::FETCH_ASSOC)) { ?>
        <div class="all">
            <form method="POST" action="SaveEditlangue.php">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Ex: 1.." name="txt1" value="<?php echo $row['code_langue'];?>" readonly>
                </div>

                <div class="form-group">
                    <label for="formGroupExampleInput2"><b>Nom langue</b></label>
                    <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="Ex: Math.." name="txt2" value="<?php echo $row['nom_langue'];?>">
                </div>
