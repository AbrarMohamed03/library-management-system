...
<body>
    ...
    $sql = "UPDATE `langue` SET nom_langue ='" . $namela . "' where code_langue=" . $codela; //créer la requête
    ...
    ?>
        <div class="butt">
            ...
            <button type="button" class="btn btn-dark"><a href="FormEditlangue.php" class="" style="text-decoration: none;color:white">Retour au formaulaire de Edit</a></button>
        </div>
    <?php
    }
    ?>
