...
<body>
    ...
    $sql = "UPDATE `domaine` SET nom_domaine ='" . $namedo . "' where code_domaine=" . $codedo; //créer la requête
    ...
    ?>
        <div class="butt">
            ...
            <button type="button" class="btn btn-dark"><a href="FormEditDomaine.php" class="" style="text-decoration: none;color:white">Retour au formaulaire de Edit</a></button>
        </div>
    <?php
    }
    ?>
